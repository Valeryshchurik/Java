 ...
 * @author NotePad.by
 */
@WebFilter(urlPatterns = {"/pages/controller"})
public class RegisterFormFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            if (Navigation.REGISTER.equals(req.getParameter(AttributeParameterEnum.COMMAND.toString().toLowerCase()))) {
                ...
                if (username == null || username.isEmpty() ||
                    ...
                    req.setAttribute(AttributeParameterEnum.ERR.toString().toLowerCase(), MessageManager.getProperty("register.empty"));
                    req.getRequestDispatcher("/" + Navigation.REGISTER + ".jsp").forward(req, res);
                }
                else if (!password.equals(confirmPassword)) {
                    req.setAttribute(AttributeParameterEnum.RESULT.toString().toLowerCase(), false);
                    req.setAttribute(AttributeParameterEnum.ERR.toString().toLowerCase(), MessageManager.getProperty("register.password_error"));
                    req.getRequestDispatcher("/" + Navigation.REGISTER + ".jsp").forward(req, res);
                }
            }
